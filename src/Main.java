...
abstract class AbstractGiveSurprises {
    ...
    protected IBag surpriseContainer;
    protected int waitTime;

    public AbstractGiveSurprises(String type, int waitTime) {
        this.surpriseContainer = BagFactory.getInstance().makeBag(type);
        this.waitTime = waitTime;
    }

    public void put(ISurprise newSurprise) {
        surpriseContainer.put(newSurprise);
    }

    public void put(IBag surprises) {
        surpriseContainer.put(surprises);
    }

    public void give() {
        if (!isEmpty()) {
            ISurprise surprise = surpriseContainer.takeOut();
            surprise.enjoy();
            giveWithPassion();
            waitBeforeNext();
        }
    ...
    public boolean isEmpty() {
        return surpriseContainer.isEmpty();
    }
...
class BagFactory implements IBagFactory {
    ...
    public IBag makeBag(String type) {
        return switch (type) {
            ...
            default -> throw new IllegalArgumentException("Unknown bag type: " + type);
        };
    }
}
...
class Candies implements ISurprise {
    ...
    public void enjoy() {
        ...
        String message = String.format("You received %d %s candies.", numberOfCandies, typeOfCandies);
        System.out.println(message);
    }

    @Override
    public String toString() {
        return String.format("[Candies] number = %d, type = %s",numberOfCandies , typeOfCandies);
    }
    ...
    public static Candies generate() {
        ...
        return new Candies(randomNumber, randomType);
    }
}
...
class FortuneCookie implements ISurprise {
    ...
    public static FortuneCookie generate() {
        ...
        return new FortuneCookie(selectedQuote);
    }
}
...
class MinionToy implements ISurprise {
    ...
    @Override
    public void enjoy() {
        String message = String.format("You got a minion named %s!", name);
        System.out.println(message);
    }

    @Override
    public String toString() {
        return String.format("[Minion] name = %s",name);
    }
